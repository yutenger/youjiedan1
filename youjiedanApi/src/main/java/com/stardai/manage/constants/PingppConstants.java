...
public class PingppConstants {
	...
	// ping++支付 ApiKey 测试使用测试版的key 正式版使用live
	//public static final String APIKEY = "sk_test_ebTO8CPenDGOunHeX1rX9Sq5";
	public static final String APIKEY = "sk_live_G88Oa9G088uDbPGyH0WHevT8";

	// ping++ 私钥 与公钥对应的在 pin++的信息里
	public static final String PRIVATEKEY = "MIICXgIBAAKBgQC60o4ZWzUrEqFRz7LETgR3FhhTUmyICewhlsFU+WYASJ3zKZHd"
	...
	// ping++ appid 正式的
	public static final String APPID = "app_LOeP4SuHub9ODqfj";

	//ping++ appid 测试的
	//public static final String APPID = "app_afTuTKW5yXjDKCSO";
