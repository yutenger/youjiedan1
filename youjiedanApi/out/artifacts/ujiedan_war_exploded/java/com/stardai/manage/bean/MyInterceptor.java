        ...
        public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object obj)
            ...
            if (method.equals("OPTIONS")) {
                ...
                if (!path.equals("/MZuser/registerForNewEdition") && !path.equals("/MZuser/login") && !path.equals("/MZuser/send")
                        && !path.contains("MZevent") && !path.contains("MZversion")&& !path.contains("MZshare")
                        && !path.equals("/MZuser/getOssToken") && !path.equals("/MZcity/queryCityList")
                        && !path.equals("/MZorder/queryOrdersByManyConditions")) {
