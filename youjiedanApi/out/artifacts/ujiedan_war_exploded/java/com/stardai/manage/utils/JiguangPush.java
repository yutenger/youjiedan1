...
public class JiguangPush {
    ...
    public static  void jPushOrders(String city,String message,long orderNo) {
        log.info("对接收" + city + "订单的用户推送信息");
        PushResult result = pushOrders(String.valueOf(city), message,orderNo);
     ...
     * @return PushResult
     */
    public static PushResult pushOrders(String city, String message,long orderNo) {
        ClientConfig clientConfig = ClientConfig.getInstance();
        JPushClient jpushClient = new JPushClient(masterSecret, appKey, null, clientConfig);
        PushPayload payload = buildPushObject_android_ios_tags_alert(city, message,orderNo);
        try {
    ...
    public static PushPayload buildPushObject_android_ios_tags_alert(
            String city,String message,long orderNo) {
    ...
    public static PushPayload buildPushObject_android_ios_alias_alert(String alias, String alert) {
        return PushPayload.newBuilder().setPlatform(Platform.all()).setAudience(Audience.tag_and(alias,alert))
