...
public interface PayMoneyMapper {
	...
	void addPayPresentMessage(@Param("userId") String userId, @Param("incomeNo") String incomeNo,
                              @Param("pathWay") String channel, @Param("money") Double amountYuan, @Param("type") Integer type);
	...
	// 根据充值的金额去查询赠送的金额
	int queryAddMoney(@Param("amount") int amount);
	 ...
	 * @Return:Integer
	 */
	Integer queryExtraMoney(@Param("amount") int amount, @Param("currentTime") long currentTime);
}
