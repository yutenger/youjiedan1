...
public class ResponseLoanUserTransferList {
	...
	public String toString() {
		return "ResponseLoanUserList [orderNo=" + orderNo + ", loanName=" + loanName + ", loanMoney=" + loanMoney
				+ ", loanTerm=" + loanTerm + ", loanLocation=" + loanLocation + ", job=" + job
				+ ", companyMonthlyIncome=" + companyMonthlyIncome + ", monthlyIncome=" + monthlyIncome
				+ ", loanIncome=" + loanIncome + ", isNative=" + isNative + ", personalShebao=" + personalShebao
				+ ", house=" + house + ", car=" + car + ", webank=" + webank + ", orderTime=" + orderTime
				+ ", priceStatus=" + priceStatus + ", billStatus=" + billStatus + "]";
	}
